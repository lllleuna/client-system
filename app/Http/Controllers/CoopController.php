...
class CoopController extends Controller
{
    ...
    public function restore(Request $request)
    {
        ...
        try {
            switch ($table) {
                ...
                case 'coop_trainings':
                    $archive = DB::table('training_archives')->where('id', $id)->first();
                    if ($archive) {
                ...
                case 'coop_awards':
                    $archive = DB::table('award_archives')->where('id', $id)->first();
                    if ($archive) {
    ...
    public function restoreIndex()
    {
        ...
        $archives = $archives->sortByDesc('deleted_at')->values();
        ...
        try {
            switch ($table) {
                ...
                case 'coop_awards':
                    ...
                    break;
                default:
                    return redirect()->back()->with('error', 'Invalid table name specified.');
            }
