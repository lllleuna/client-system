...
<x-accredit-steps>
    <form action="{{ route('processForm2') }}" method="POST" enctype="multipart/form-data" class="max-w-2xl mx-auto py-8">
        ...
        <div id="imageModal" class="fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center hidden z-50">
            ...
            <!-- File Upload Section -->
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                <h2 class="text-lg font-semibold text-gray-800 mb-4">Upload Your Requirements <span class="text-red-600">*</span></h2>
                <div class="space-y-4">
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center" id="upload_container">
                        <input type="file" id="file_upload" name="file_upload" class="hidden" accept="image/*" required>
                        <label for="file_upload" id="upload_label" class="cursor-pointer">
                            <div class="space-y-2">
                                ...
                                <div class="text-gray-600">Click to upload your file <span class="text-red-600">*</span></div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                ...
                <div class="prose prose-sm text-gray-600">
                    <p>The Office of the Transportation Cooperatives (OTC) recognizes and protects your rights as data subject by applying appropriate security measures in compliance with existing laws on data privacy, records management and cyber security.</p>
                </div>
            </div>
            <!-- Consent Section -->
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                <h2 class="text-lg font-semibold text-gray-800 mb-4">Required Declarations <span class="text-red-600">*</span></h2>
                <div class="flex items-start space-x-3">
                    ...
                    <label for="consent_checkbox" class="text-sm text-gray-600">
                        I am giving my consent for the Office of the Transportation Cooperatives to collect and process my data. <span class="text-red-600">*</span>
                    </label>
                </div>
                <div id="consent_error" class="ml-7 text-sm text-red-600 hidden">Please provide your consent to continue</div>
                
                <div class="flex items-start space-x-3 mt-4">
                    <input type="checkbox" id="oath" name="oath" required
                        class="mt-1 w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                    <label for="oath" class="text-sm text-gray-600">
                        I hereby certify that all information I have provided prior to and during this application, as recorded on this website, is true, correct, and updated to the best of my knowledge. <span class="text-red-600">*</span>
                    </label>
                </div>
                <div id="oath_error" class="ml-7 text-sm text-red-600 hidden">Please certify that all information is true and correct</div>
            </div>
            <!-- Contact Section -->
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                ...
                <div class="space-y-3">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="flex items-center space-x-2">
                            ...
                            <a href="mailto:official@otc.gov.ph" class="text-blue-600 hover:text-blue-800">official@otc.gov.ph</a>
                        </div>
                        <div class="flex items-center space-x-2">
                            <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                            </svg>
                            <a href="https://www.facebook.com/DOTR.OTC" target="_blank" class="text-blue-600 hover:text-blue-800">https://www.facebook.com/DOTR.OTC</a>
                        </div>
                        <div class="flex items-center space-x-2">
                            <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="mt-10 flex justify-between">
                ...
                <button type="submit" id="submit_button" class="bg-blue-900 text-white px-4 py-2 rounded-lg hover:bg-blue-800 focus:outline-none opacity-50 cursor-not-allowed" disabled>Next</button>
            </div>
        </div>
    </form>
</x-accredit-steps>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const changeFileBtn = document.getElementById('change_file');
        const fileError = document.getElementById('file_error');
        
        // Consent and oath checkboxes
        ...
        const oathError = document.getElementById('oath_error');
        ...
        oathCheckbox.addEventListener('change', function() {
            if (this.checked) {
                oathError.classList.add('hidden');
            } else {
                oathError.classList.remove('hidden');
            }
            validateForm();
        });
