                ...
                <div id="phone-form" class="transition-opacity duration-300">
                    <form id="verify-phone-form" method="POST" action="{{ route('send.otp') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="contact_no" id="contact_no" value="{{ auth()->user()->pending_contact_no }}" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="63 900 000 0000">
