        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex space-x-6">
                    <a href="{{ route('login') }}"
                        class="nav-link {{ request()->routeIs('login') ? 'text-blue-400' : 'text-white' }}">Home</a>
                    <a href="{{ route('about') }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-300">
                        ...
                        <li>Address: 5th Floor Ben-Lor Bldg., Brgy. Paligsahan, 1184 Quezon Avenue, Quezon City 1103
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <div class="flex space-x-4">
                        {{-- Facebook --}}
                        <a href="https://www.facebook.com/DOTR.OTC" class="text-gray-300 hover:text-white">
