                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 lg:p-6">
                    ...
                    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6 space-y-4 lg:space-y-0">
                        ...
                        <div class="flex flex-col sm:flex-row w-full lg:w-auto space-y-3 sm:space-y-0 sm:space-x-3">
                            <a href="{{ route('editawards') }}" class="inline-flex items-center justify-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all duration-200">
                            ...
                            <div class="overflow-x-auto">
                                <table class="min-w-full bg-white rounded-lg overflow-hidden">
                                    ...
                                    <tbody>
                                        <!-- Sample row 1 -->
                                        <tr>
                                            <td class="py-3 px-4 border text-left">City Government of San Fernando, La Union</td>
                                            <td class="py-3 px-4 border text-left">Certificate of Accreditation</td>
                                            <td class="py-3 px-4 border text-left">June 15, 2022</td>
                                        ...
                                        <!-- Sample row 2 -->
                                        <tr class="bg-gray-50">
                                            <td class="py-3 px-4 border text-left">Provincial Government of La Union</td>
                                            <td class="py-3 px-4 border text-left">Certificate of Accreditation</td>
                                            <td class="py-3 px-4 border text-left">August 23, 2021</td>
                                            <td class="py-3 px-4 border text-center">
                                                <div class="flex justify-center space-x-2">
                                                    <a href="#" class="text-blue-600 hover:text-blue-800">
                                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <!-- Sample row 3 -->
                                        <tr>
                                            <td class="py-3 px-4 border text-left">Land Bank of the Philippines</td>
                                            <td class="py-3 px-4 border text-left">Plaque of Recognition</td>
                                            <td class="py-3 px-4 border text-left">March 12, 2019</td>
                                            <td class="py-3 px-4 border text-center">
                                                <div class="flex justify-center space-x-2">
                                                    <a href="#" class="text-blue-600 hover:text-blue-800">
                                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <tr class="bg-gray-50">
                                            <td class="py-3 px-4 border text-left">Land Bank of the Philippines</td>
                                            <td class="py-3 px-4 border text-left">2018 Gawad Saka for Outstanding Small Farmer Fisher Folk Organization</td>
                                            <td class="py-3 px-4 border text-left">November 30, 2018</td>
                                            <td class="py-3 px-4 border text-center">
                                                <div class="flex justify-center space-x-2">
                                                    <a href="#" class="text-blue-600 hover:text-blue-800">
                                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
