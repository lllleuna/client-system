                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 lg:p-6">
                    ...
                    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6 space-y-4 lg:space-y-0">
                        ...
                        <div class="flex flex-col sm:flex-row w-full lg:w-auto space-y-3 sm:space-y-0 sm:space-x-3">
                            <a href="{{ route('editbusinesses') }}" class="inline-flex items-center justify-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all duration-200">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg mb-6">
                        <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
                            ...
                            <div class="w-full sm:w-1/4">
                                ...
                                <select id="type" name="type" class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <div class="w-full sm:w-1/4">
                                <label for="years" class="block text-sm font-medium text-gray-700 mb-1">Filter by Years</label>
                                <select id="years" name="years" class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                                ...
                                <table class="min-w-full bg-white rounded-lg overflow-hidden">
                                    <thead class="bg-gray-100 text-gray-700">
                                        <tr>
                                            ...
                                            <th class="py-3 px-4 border text-left">Years of Existence</th>
                                    ...
                                    <tbody>
                                        <!-- Sample row 1 -->
                                        <tr>
                                            <td class="py-3 px-4 border text-left">Existing</td>
                                            <td class="py-3 px-4 border text-left">Transportation Services</td>
                                            <td class="py-3 px-4 border text-left">₱850,000.00</td>
                                            <td class="py-3 px-4 border text-left">₱1,250,000.00</td>
                                            <td class="py-3 px-4 border text-left">3.5</td>
                                            <td class="py-3 px-4 border text-left">
                                                <span class="px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                                    Active
                                                </span>
                                            </td>
                                            <td class="py-3 px-4 border text-left">Primary business unit, profitable since Y2</td>
                                        ...
                                        <tr class="bg-gray-50">
                                            <td class="py-3 px-4 border text-left">Existing</td>
                                            <td class="py-3 px-4 border text-left">Logistics & Delivery</td>
                                            <td class="py-3 px-4 border text-left">₱500,000.00</td>
                                            <td class="py-3 px-4 border text-left">₱600,000.00</td>
                                            <td class="py-3 px-4 border text-left">1.2</td>
                                            <td class="py-3 px-4 border text-left">
                                                <span class="px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                                    Continuing
                                                </span>
                                            </td>
                                            <td class="py-3 px-4 border text-left">Secondary business line, expanding service area</td>
                                            <td class="py-3 px-4 border text-center">
                                                <div class="flex justify-center space-x-2">
                                                    <a href="#" class="text-blue-600 hover:text-blue-800">
                                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <!-- Sample row 3 -->
                                        <tr>
                                            <td class="py-3 px-4 border text-left">Proposed</td>
                                            <td class="py-3 px-4 border text-left">E-commerce Platform</td>
                                            <td class="py-3 px-4 border text-left">₱1,200,000.00</td>
                                            <td class="py-3 px-4 border text-left">₱0.00</td>
                                            <td class="py-3 px-4 border text-left">0</td>
                                            <td class="py-3 px-4 border text-left">
                                                <span class="px-2 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                                                    On-going
                                                </span>
                                            </td>
                                            <td class="py-3 px-4 border text-left">Development phase, launch planned for Q3 2025</td>
                                            <td class="py-3 px-4 border text-center">
                                                <div class="flex justify-center space-x-2">
                                                    <a href="#" class="text-blue-600 hover:text-blue-800">
                                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <tr class="bg-gray-50">
                                            <td class="py-3 px-4 border text-left">Existing</td>
                                            <td class="py-3 px-4 border text-left">Vehicle Rental</td>
                                            <td class="py-3 px-4 border text-left">₱1,500,000.00</td>
                                            <td class="py-3 px-4 border text-left">₱800,000.00</td>
                                            <td class="py-3 px-4 border text-left">2.5</td>
                                            <td class="py-3 px-4 border text-left">
                                                <span class="px-2 py-1 rounded-full text-xs font-medium bg-red-100 text-red-800">
                                                    Non-operational
                                                </span>
                                            </td>
                                            <td class="py-3 px-4 border text-left">Temporarily suspended due to market conditions</td>
                                            <td class="py-3 px-4 border text-center">
                                                <div class="flex justify-center space-x-2">
                                                    <a href="#" class="text-blue-600 hover:text-blue-800">
                                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
