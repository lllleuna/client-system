                    ...
                    <form action="#" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="flex space-x-4">
                                    <label class="inline-flex items-center">
                                        <input type="radio" name="business_type" value="existing" class="mr-2" {{ old('business_type', $business->business_type ?? '') == 'existing' ? 'checked' : '' }} required>
                                        <span>Existing</span>
                                    </label>
                                    <label class="inline-flex items-center">
                                        <input type="radio" name="business_type" value="proposed" class="mr-2" {{ old('business_type', $business->business_type ?? '') == 'proposed' ? 'checked' : '' }} required>
                                        <span>Proposed</span>
                                    </label>
                                </div>
                                @error('business_type')
                            ...
                            <div>
                                ...
                                <input type="number" name="years_existence" value="{{ old('years_existence', $business->years_existence ?? '') }}"
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" name="starting_capital" value="{{ old('starting_capital', $business->starting_capital ?? '') }}" 
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" name="capital_to_date" value="{{ old('capital_to_date', $business->capital_to_date ?? '') }}" 
                        ...
                        <div>
                            ...
                            <textarea name="status_comment" rows="3"
                                    ...
                                    placeholder="E.g. NON-OPERATIONAL, OPERATIONAL, EXISTING, ACTIVE, ON-GOING">{{ old('status_comment', $business->status_comment ?? '') }}</textarea>
