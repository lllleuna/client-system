                                ...
                                <div>
                                    ...
                                    <select name="type"
                                        ...
                                        <option value="PUJ TRADITIONAL"
                                            {{ old('type', $coopunit->type ?? '') == 'PUJ TRADITIONAL' ? 'selected' : '' }}>PUJ TRADITIONAL</option>
                                        <option value="UV EXPRESS TRADITIONAL"
                                            {{ old('type', $coopunit->type ?? '') == 'UV EXPRESS TRADITIONAL' ? 'selected' : '' }}>UV EXPRESS TRADITIONAL
                                        </option>
                                        <option value="MULTICAB/FILCAB"
                                            {{ old('type', $coopunit->type ?? '') == 'MULTICAB/FILCAB' ? 'selected' : '' }}>MULTICAB/FILCAB</option>
                                        <option value="BUS"
                                            {{ old('type', $coopunit->type ?? '') == 'BUS' ? 'selected' : '' }}>BUS
                                        </option>
                                        <option value="MINIBUS"
                                            {{ old('type', $coopunit->type ?? '') == 'MINIBUS' ? 'selected' : '' }}>MINIBUS</option>
                                        <option value="TOURIST"
                                            {{ old('type', $coopunit->type ?? '') == 'TOURIST' ? 'selected' : '' }}>TOURIST
                                        </option>
                                        <option value="TAXI"
                                            {{ old('type', $coopunit->type ?? '') == 'TAXI' ? 'selected' : '' }}>TAXI</option>
                                        <option value="TRUCK"
                                            {{ old('type', $coopunit->type ?? '') == 'TRUCK' ? 'selected' : '' }}>TRUCK
                                        </option>
                                        <option value="MPUV C1 ELECTRTIC"
                                            {{ old('type', $coopunit->type ?? '') == 'MPUV C1 ELECTRTIC' ? 'selected' : '' }}>MPUV C1 ELECTRTIC</option>
                                        <option value="MPUV C1 EURO"
                                            {{ old('type', $coopunit->type ?? '') == 'MPUV C1 EURO' ? 'selected' : '' }}>MPUV C1 EURO
                                        </option>
                                        <option value="MPUV C1 SOLAR"
                                            {{ old('type', $coopunit->type ?? '') == 'MPUV C1 SOLAR' ? 'selected' : '' }}>MPUV C1 SOLAR</option>
                                        <option value="VAN (TOURIST)"
                                            {{ old('type', $coopunit->type ?? '') == 'VAN (TOURIST)' ? 'selected' : '' }}>VAN (TOURIST)
                                        </option>
                                    </select>
                                    @error('type')
