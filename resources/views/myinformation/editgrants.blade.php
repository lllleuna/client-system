                    ...
                    <form action="#" method="POST" class="space-y-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="date_acquired" value="{{ old('date_acquired', $acquisition->date_acquired ?? '') }}"
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" name="amount" value="{{ old('amount', $acquisition->amount ?? '') }}" 
                            ...
                            <div>
                                ...
                                <input type="text" name="source" value="{{ old('source', $acquisition->source ?? '') }}"
                            ...
                            <div>
                                ...
                                <textarea name="remarks" rows="3"
                                          ...
                                          placeholder="Enter status or remarks">{{ old('remarks', $acquisition->remarks ?? '') }}</textarea>
                                @error('remarks')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
