            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-9">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                        ...
                        <form action="{{ $mode == 'edit' ? route('loan.update', $loan->id) : route('addloan') }}"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="financing_institution"
                                        value="{{ old('financing_institution', $loan->financing_institution ?? '') }}"
                                ...
                                <div>
                                    ...
                                    <input type="date" name="acquired_at"
                                        value="{{ old('acquired_at', $loan->acquired_at ?? '') }}"
                                        max="{{ \Carbon\Carbon::today()->format('Y-m-d') }}"
                                        class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-100 focus:border-blue-400 transition-all duration-200 @error('acquired_at') border-red-500 @enderror"
                                        required>
                                    @error('acquired_at')
                                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    @if (isset($loan) && $loan->file_upload)
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <p class="text-sm text-gray-600">
                                                <a href="{{ asset('shared/' . $loan->file_upload) }}" target="_blank"
                                                    class="text-blue-500 hover:underline">
                                                    {{ basename($loan->file_upload) }}
                                                </a>
                                            </p>
                                ...
                                <div>
                                    ...
                                    <textarea name="remarks" rows="3"
                                        ...
                                        placeholder="Enter current status or additional remarks">{{ old('remarks', $loan->remarks ?? '') }}</textarea>
                                    @error('remarks')
                                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                    @enderror
                                </div>
