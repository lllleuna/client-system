                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 lg:p-6">
                    ...
                    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6 space-y-4 lg:space-y-0">
                        ...
                        <div class="flex flex-col sm:flex-row w-full lg:w-auto space-y-3 sm:space-y-0 sm:space-x-3">
                            <a href="{{ route('editgeneralinfo') }}" class="inline-flex items-center justify-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all duration-200">
                                ...
                                <div class="space-y-4">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div class="bg-white p-4 rounded-lg shadow-sm">
                                            ...
                                            <p class="text-md font-semibold text-gray-800">{{ $generalInfo->date_accredited ?? 'Not Available' }}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-white p-4 rounded-lg shadow-sm">
                                        ...
                                        <p class="text-md font-semibold text-gray-800">{{ $generalInfo->membership_fee ?? 'Not Available' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div class="bg-white p-4 rounded-lg shadow-sm">
                                        ...
                                        <p class="text-md font-semibold text-gray-800">{{ $generalInfo->bir_tin ?? 'Not Available' }}</p>
                                    </div>
                                    
                                    <div class="bg-white p-4 rounded-lg shadow-sm">
                                        <p class="text-sm text-gray-500 font-medium mb-1">BIR TAX EXEMPTION NUMBER</p>
                                        <p class="text-md font-semibold text-gray-800">{{ $generalInfo->bir_tax_exemption_no ?? 'Not Available' }}</p>
                                    </div>
                                    
                                    <div class="bg-white p-4 rounded-lg shadow-sm">
                                        <p class="text-sm text-gray-500 font-medium mb-1">VALIDITY</p>
                                        <p class="text-md font-semibold text-gray-800">{{ $generalInfo->bir_validity ?? 'Not Available' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
