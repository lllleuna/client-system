...
<div class="max-w-4xl mx-auto p-6">
    ...
    <div class="mb-8 bg-white rounded-lg shadow-md p-6">
        ...
        <div class="prose max-w-none text-gray-600">
            <p class="mb-4">
                This comprehensive training program is designed to equip you with essential knowledge about transportation cooperatives 
            ...
            <div class="bg-blue-50 border-l-4 border-blue-500 p-4 my-4">
                ...
                <p class="text-sm">
                    This training is mandatory for Transportation Cooperative registration with CDA, as stipulated in Rule V, 
    ...
    <form action="#" method="POST" enctype="multipart/form-data" class="space-y-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="grid md:grid-cols-2 gap-4">
                {{-- Face to Face Option --}}
                <label class="relative border-2 rounded-lg p-4 cursor-pointer transition-all hover:border-blue-200 @error('training_type') border-red-300 @enderror">
                ...
                <label class="relative border-2 rounded-lg p-4 cursor-pointer transition-all hover:border-blue-200 @error('training_type') border-red-300 @enderror">
                    ...
                    <ul class="mt-3 text-sm text-gray-500 pl-6 list-disc space-y-1">
                        ...
                        <li>Interactive online materials</li>
                    </ul>
                </label>
                @error('training_type')
            ...
            <div class="space-y-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-dashed rounded-lg @error('letter_of_intent') border-red-300 @enderror">
                            <div class="space-y-1 text-center">
                                <svg class="mx-auto h-12 w-12 text-gray-400" stroke="currentColor" fill="none" viewBox="0 0 48 48">
                                    <path d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                                <div class="flex text-sm text-gray-600">
                                    <label for="letter_of_intent" class="relative cursor-pointer rounded-md font-medium text-blue-600 hover:text-blue-500">
                                        <span>Upload a file</span>
                                        <input id="letter_of_intent" name="letter_of_intent" type="file" class="sr-only" required accept=".pdf">
                                    </label>
